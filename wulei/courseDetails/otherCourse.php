...
<section class="course-advertise">
	<div class="ad-img">
...
<div class="course-list clearfix">
	<article class="courses-content">
		...
		<tr class="table-up">
			<td>课程周期 :</td>
			<td><?php echo $row["classCycle"];?></td>
		</tr>
		<tr class="table-up">
			<td>课程价格 :</td>
			<td><?php echo $row["classPrice"];?></td>
		</tr>
		<tr class="table-up">
			<td>学校地址 :</td>
			<td><?php echo $row["shoolAddress"];?></td>
		</tr>
		...
		<tr class="table-down">
			<td>学习目标 :</td>
			<td><?php echo $row["learningGoals"];?></td>
		</tr>
		<tr class="table-down">
			<td>使用教材 :</td>
			<td><?php echo $row["coursebook"];?></td>
		</tr>
...
<div class="judge-details">
	...
	<ul class="hot-course-list">
		...
		<a href="javascript:void(0)">
			...
			<p class="course-name">4个月IOS高薪就业班...</p>
			<p>北京市海淀区清河中街金...</p>
			<span>￥</span><span>1288</span>
			</div>
		</a>
		</li>
		<li class="hot-course">
